...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'weights/exp2/weights/best.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=r"G:\demo_code\yolov5-6.2\data\01_t\11.jpg", help='file/dir/URL/glob, 0 for webcam')
