...
def export_onnx(model, im, file, opset, train, dynamic, simplify, prefix=colorstr('ONNX:')):
    ...
    try:
        ...
        torch.onnx.export(
            ...
            dynamic_axes={
                'images': {
                    0: 'batch',},  # shape(1,3,640,640)
                'output': {
                    0: 'batch'}  # shape(1,25200,85)
            } if dynamic else None)
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'weights/jms_1024_exp3_best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--verbose', action='store_true',default=True, help='TensorRT: verbose log')
