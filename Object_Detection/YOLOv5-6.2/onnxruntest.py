...
class YOLOV5_ONNX(object):
    ...
    def infer(self,img_path):
        ...
        print(torch.tensor(pred[0].shape))
        print(torch.tensor(pred[1].shape))
        print(torch.tensor(pred[2].shape))
#---------------------------------------------------------------------------------------
        #提取出特征
        y = []
...
if __name__=="__main__":
    model=YOLOV5_ONNX(onnx_path=r"D:\code\yolov5-6.0\weights\hzh_best.onnx")
    # model.infer(img_path=r"D:\download\yolov5-5.0\data\images\1.jpg")
    model.infer(img_path=r"D:\code\yolov5-6.0\data\1.jpg")
