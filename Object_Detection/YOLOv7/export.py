...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/yolov728/weights/last.pt', help='weights path')
    ...
    parser.add_argument('--grid', default=True
                        ,action='store_true', help='export Detect() layer grid')
    parser.add_argument('--end2end',default=True, action='store_true', help='export end2end onnx')
